...
import { HomeworkForm, type LLMConfigOption } from "../components/HomeworkForm";
...
export function HomeworkCreateView({
  ...
  // Without this, the Save button stayed clickable through the whole
  // POST -> PATCH -> publish/hide chain -- a second click while the first
  // was still in flight (no "saving..." feedback exists) fired a fully
  // independent submit, creating a second bare homework alongside
  // whichever one the first attempt left behind on failure.
