...
docker start llteacher-floci >/dev/null 2>&1 || docker run -d --name llteacher-floci -p 4566:4566 -e FLOCI_STORAGE_MODE=hybrid -v /var/run/docker.sock:/var/run/docker.sock -v "$root/.floci/data:/app/data" floci/floci:latest >/dev/null
